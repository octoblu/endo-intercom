...
class Command
  getOptions: =>
    throw new Error MISSING_SERVICE_URL if _.isEmpty process.env.ENDO_INTERCOM_SERVICE_URL
    throw new Error MISSING_MANAGER_URL if _.isEmpty process.env.ENDO_INTERCOM_MANAGER_URL
    ...
    return {
      ...
      serviceUrl:      process.env.ENDO_INTERCOM_SERVICE_URL
      userDeviceManagerUrl: process.env.ENDO_INTERCOM_MANAGER_URL
      staticSchemasPath: process.env.ENDO_INTERCOM_STATIC_SCHEMAS_PATH
    }
